...
final class GridCollectionViewFlowLayout: UICollectionViewFlowLayout {
  ...
  override var collectionViewContentSize: CGSize {
    ...
    let contentHeight = CGFloat(sectionsCount) * itemHeight
    return CGSize(width: contentWidth, height: contentHeight)
  }

  override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
    var startIndexY = Int(rect.origin.y / itemHeight)
    ...
    var numberOfVisibleCellsInRectY = Int((rect.height / itemHeight).rounded(.up)) + startIndexY
  ...
  override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
    ...
    let yPos = CGFloat(indexPath.section) * height
  ...
  private func updateCache() {
    ...
    guard previousLeftBoundX != boundIndexes.left && previousRightBoundX != boundIndexes.right else { return }
